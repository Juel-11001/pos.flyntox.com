...
function get_featured_products() {
    ...
    if (location_id && $('#featured_products_box').length > 0) {
        var url = '/sells/pos/get-featured-products/' + location_id;
        if ($('#__is_viho_template').length > 0) {
            url = '/ai-template/sells/pos/get-featured-products/' + location_id;
        }
        $.ajax({
            method: 'GET',
            url: url,
...
function get_product_suggestion_list(category_id, brand_id, location_id, url = null, is_enabled_stock = null, repair_model_id = null) {
    ...
    if (url == null) {
        ...
        if ($('#__is_viho_template').length > 0) {
            url = '/ai-template/sells/pos/get-product-suggestion';
        }
    }
...
function get_recent_transactions(status, element_obj) {
    ...
    var url = '/sells/pos/get-recent-transactions';
    if ($('#__is_viho_template').length > 0) {
        url = '/ai-template/sells/pos/get-recent-transactions';
    }
    $.ajax({
        method: 'GET',
        url: url,
