<div class="table-responsive">
    @if(in_array('create', $permissions))
        <div class="pull-right">
            <button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm docs_and_notes_btn pull-right" data-href="{{ route('note-documents.create', ['notable_id' => $notable_id, 'notable_type' => $notable_type]) }}">
                @lang('messages.add')&nbsp;
