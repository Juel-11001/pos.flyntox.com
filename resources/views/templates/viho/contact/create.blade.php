<div class="modal-dialog modal-lg" role="document">
  ...
  @endphp
    ...
    <div class="modal-body">
        ...
        <div class="row">
            <div class="col-md-12">
                <button type="button" class=" bnt btn-primary tw-dw-btn-sm center-block more_btn" data-target="#more_div">@lang('lang_v1.more_info') <i class="fa fa-chevron-down"></i></button>
            </div>
