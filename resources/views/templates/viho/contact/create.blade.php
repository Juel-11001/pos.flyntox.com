<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    ...
    $url = route('ai-template.contacts.store');
    ...
    <div class="modal-body">
      <div class="row">
        <div class="col-md-4 contact_type_div">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::select('type', $types, $type , ['class' => 'form-control', 'id' => 'contact_type','placeholder'
              => __('messages.please_select'), 'required', 'onchange' => "var form=this.form;if(!form)return;var
              target=(['supplier','both'].indexOf(this.value)!==-1)?'business':'individual';var
              radio=form.querySelector('input[name=\"contact_type_radio\"][value=\"'+target+'\"]');if(radio){radio.checked=true;radio.dispatchEvent(new
            ...
            <div class="radio-group">
              <label class="radio-inline">
                <input type="radio" name="contact_type_radio" id="inlineRadio1" value="individual"
                  @if($default_contact_mode==='individual' ) checked @endif
              ...
              <label class="radio-inline">
                <input type="radio" name="contact_type_radio" id="inlineRadio2" value="business"
                  @if($default_contact_mode==='business' ) checked @endif
        ...
        <div class="col-md-3 individual" @if($default_contact_mode !=='individual' ) style="display: none;" @endif>
          <div class="form-group">
            ...
            ] + ($default_contact_mode === 'individual' ? ['required' => true] : [])); !!}
          </div>
        </div>
        <div class="col-md-3 individual" @if($default_contact_mode !=='individual' ) style="display: none;" @endif>
          <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="input-group flex-nowrap">
              ...
              {!! Form::select('assigned_to_users', $users ?? [], null , ['class' => 'form-control select2',
              'id' => 'assigned_to_users', 'placeholder' => __('messages.please_select'), 'style' => 'width: 100%;']); !!}
            </div>
          </div>
        </div>
        @endif
        ...
        <div class="col-md-6 lead_additional_div" @if(!$is_lead_form) style="display: none;" @endif>
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              'placeholder' => __('messages.please_select'), 'style' => 'width: 100%;'] + ($is_lead_form ? ['required' => true] : [])); !!}
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <button type="button" class="bnt btn-primary rounded tw-dw-btn-sm center-block more_btn"
        ...
        <div id="more_div" class="hide">
          ...
          <div class="col-sm-12 col-md-6 col-lg-4 opening_balance">
            <div class="form-group">
          ...
          <div class="col-sm-12 col-md-6 col-lg-4 pay_term">
            <div class="form-group">
              <div class="multi-input">
                <div class='d-flex align-items-center gap-3'>
                  <span>{!! Form::label('pay_term_number', __('contact.pay_term') . ':') !!}</span>
                  <span>@show_tooltip(__('tooltip.pay_term'))</span>
                </div>
          ...
          @endphp
          <div class="col-sm-12 col-md-6 col-lg-4 customer_fields">
            <div class="form-group">
          ...
          <div class="col-sm-12 col-md-6 col-lg-4">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                {!! Form::text('land_mark', null, ['class' => 'form-control', 'placeholder' =>
                __('business.land_mark')]); !!}
              </div>
            </div>
          </div>
          <div class="col-sm-12 col-md-6 col-lg-4">
          ...
          <div class="col-sm-12 col-md-6 col-lg-4">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                {!! Form::text('building_number', null, ['class' => 'form-control', 'placeholder' =>
                __('business.building_number')]); !!}
              </div>
            </div>
          </div>
          <div class="col-sm-12 col-md-6 col-lg-4">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                {!! Form::text('additional_number', null, ['class' => 'form-control', 'placeholder' =>
                __('business.additional_number')]); !!}
              </div>
            </div>
          </div>
          ...
          <div class="col-md-8 shipping_addr_div" style='margin: 20px auto;'>
...
(function($) {
  ...
  function syncVihoContactTypeFields() {
    ...
    var preferredMode = ['supplier', 'both'].indexOf($form.find('#contact_type').val()) !== -1 ? 'business' :
      'individual';
...
<style>
  #contact_add_form .select2-container--default .select2-selection--single {
  ...
  #contact_add_form .select2-container--default .select2-selection--single .select2-selection__rendered {
    line-height: 38px;
    padding-left: 12px;
    color: #444;
  }

  #contact_add_form .select2-container--default .select2-selection--single .select2-selection__arrow {
    height: 36px;
  }

  #contact_add_form .select2-container--default .select2-selection--multiple {
    border: 1px solid #e6edef;
    border-radius: 6px;
    min-height: 38px;
    padding: 2px 8px;
  ...
  #contact_add_form .select2-container--default .select2-selection--multiple .select2-selection__choice {
    background: #24695c;
  ...
  #contact_add_form .select2-container--default .select2-selection--multiple .select2-selection__choice__remove {
    color: rgba(255, 255, 255, 0.8) !important;
    margin-right: 5px;
  }

  #contact_add_form .select2-container--default .select2-selection--multiple .select2-selection__choice__remove:hover {
    color: #fff !important;
    background: transparent;
  }

  #contact_add_form .input-group .select2-container {
    flex: 1 1 auto;
    width: 1% !important;
  }

  #contact_add_form .input-group .select2-selection--multiple {
    border-top-left-radius: 0;
    border-bottom-left-radius: 0;
  }

  #contact_add_form .select2-container--default .select2-search--inline .select2-search__field {
    margin-top: 0;
    height: 32px;
  }
</style>