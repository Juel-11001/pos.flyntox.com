...
<section class="content">
  ...
  <div class="row">
    <div class="col-sm-12">
      ...
      {!! Form::open(['url' => action([\App\Http\Controllers\ContactController::class, 'postImportContacts']), 'method'
  ...
  <div class="row">
    <div class="col-sm-12">
      ...
      <table class="table table-striped">
        ...
        <tr>
          <td>10</td>
          <td>@lang('contact.pay_term') <br><small class="text-muted">(@lang('lang_v1.required_if_supplier'))</small>
          </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          <td>15</td>
          <td>@lang('contact.alternate_contact_number') <small class="text-muted">(@lang('lang_v1.optional'))</small>
          </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
