...
@endphp
<div class="row">
    <div class="col-md-12 viho-ledger-toolbar">
        ...
        <div class="col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <div class="btn-group viho-ledger-format-group" data-toggle="buttons">
        ...
        <div class="col-md-2 col-sm-6 text-right viho-ledger-actions">
