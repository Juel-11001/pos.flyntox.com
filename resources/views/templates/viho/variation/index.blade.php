...
<section class="content-header">
  <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('product.variations')
    <small
      class="tw-text-sm md:tw-text-base tw-text-gray-700 tw-font-semibold">@lang('lang_v1.manage_product_variations')</small>
  </h1>
  <!-- <ol class="breadcrumb">
...
<section class="content">
  ...
  <div class="box-tools">
    <a class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full btn-modal"
      data-href="{{ route('ai-template.variation-templates.create') }}" data-container=".variation_modal">
