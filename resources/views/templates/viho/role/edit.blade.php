...
<!-- Main content -->
<section class="content viho-icheck-reset">
  @php
  $pos_settings = !empty(session('business.pos_settings')) ? json_decode(session('business.pos_settings'), true) : [];
  @endphp
  @component('components.widget', ['class' => 'box-primary'])
  {!! Form::open(['url' => route('ai-template.roles.update', [$role->id]), 'method' => 'PUT', 'id' => 'role_form' ]) !!}
  <div class="row">
    <div class="col-md-4">
  ...
  <div class="row check_group align-items-center">
    ...
    <div class="col-md-7">
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'view_export_buttons', in_array('view_export_buttons',
            $role_permissions),
  ...
  <div class="row check_group align-items-center">
    ...
    <div class="col-xs-12 col-md-7">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[supplier_view]', 'supplier.view', in_array('supplier.view',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[supplier_view]', 'supplier.view_own', in_array('supplier.view_own',
            $role_permissions),
  ...
  <div class="row check_group align-items-center">
    ...
    <div class="col-xs-12 col-md-7">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[customer_view]', 'customer.view', in_array('customer.view',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[customer_view]', 'customer.view_own', in_array('customer.view_own',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[customer_view_by_sell]', 'customer_with_no_sell_one_month',
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[customer_view_by_sell]', 'customer_with_no_sell_three_month',
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[customer_view_by_sell]', 'customer_with_no_sell_six_month',
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[customer_view_by_sell]', 'customer_with_no_sell_one_year',
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[customer_view_by_sell]', 'customer_irrespective_of_sell',
  ...
  <div class="row check_group align-items-center">
    ...
    <div class="col-xs-12 col-md-7">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[purchase_view]', 'purchase.view', in_array('purchase.view',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[purchase_view]', 'view_own_purchase', in_array('view_own_purchase',
            $role_permissions),['class' => 'input-icheck']); !!}
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'edit_purchase_payment', in_array('edit_purchase_payment',
            $role_permissions),['class' => 'input-icheck']); !!}
  ...
  <div class="row check_group align-items-center">
    ...
    <div class="col-xs-12 col-md-7">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[stock_adjustment_view]', 'stock_adjustment.view',
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[stock_adjustment_view]', 'view_own_stock_adjustment',
            in_array('view_own_stock_adjustment', $role_permissions),['class' => 'input-icheck']); !!}
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'stock_adjustment.create', in_array('stock_adjustment.create',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'stock_adjustment.update', in_array('stock_adjustment.update',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'stock_adjustment.delete', in_array('stock_adjustment.delete',
            $role_permissions),
  ...
  <div class="row check_group align-items-center">
    ...
    <div class="col-xs-12 col-md-7">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[stock_transfer_view]', 'stock_transfer.view', in_array('stock_transfer.view',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[stock_transfer_view]', 'stock_transfer.view_own',
            in_array('stock_transfer.view_own', $role_permissions),['class' => 'input-icheck']); !!}
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'stock_transfer.update', in_array('stock_transfer.update',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'stock_transfer.delete', in_array('stock_transfer.delete',
            $role_permissions),
  ...
  <div class="row check_group align-items-center">
    ...
    <div class="col-xs-12 col-md-7">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[purchase_requisition_view]', 'purchase_requisition.view_all',
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[purchase_requisition_view]', 'purchase_requisition.view_own',
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'purchase_requisition.create', in_array('purchase_requisition.create',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'purchase_requisition.delete', in_array('purchase_requisition.delete',
            $role_permissions),
  ...
  <div class="row check_group align-items-center">
    ...
    <div class="col-xs-12 col-md-7">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[purchase_order_view]', 'purchase_order.view_all',
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[purchase_order_view]', 'purchase_order.view_own',
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'purchase_order.create', in_array('purchase_order.create',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'purchase_order.update', in_array('purchase_order.update',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'purchase_order.delete', in_array('purchase_order.delete',
            $role_permissions),
  ...
  <div class="row check_group align-items-center">
    ...
    <div class="col-xs-12 col-md-7">
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'print_invoice', in_array('print_invoice', $role_permissions), ['class'
            => 'input-icheck']); !!}
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'disable_pay_checkout', in_array('disable_pay_checkout',
            $role_permissions), ['class' => 'input-icheck']); !!}
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'disable_draft', in_array('disable_draft', $role_permissions), ['class'
            => 'input-icheck']); !!}
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'disable_express_checkout', in_array('disable_express_checkout',
            $role_permissions), ['class' => 'input-icheck']); !!}
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'disable_suspend_sale', in_array('disable_suspend_sale',
            $role_permissions), ['class' => 'input-icheck']); !!}
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'disable_credit_sale', in_array('disable_credit_sale',
            $role_permissions), ['class' => 'input-icheck']); !!}
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'disable_card', in_array('disable_card', $role_permissions), ['class' =>
            'input-icheck']); !!}
  ...
  <div class="row check_group align-items-center">
    ...
    <div class="col-xs-12 col-md-7">
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[sell_view]', 'direct_sell.view', in_array('direct_sell.view',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[sell_view]', 'view_own_sell_only', in_array('view_own_sell_only',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'view_paid_sells_only', in_array('view_paid_sells_only',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'view_due_sells_only', in_array('view_due_sells_only',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'view_overdue_sells_only', in_array('view_overdue_sells_only',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'view_commission_agent_sell', in_array('view_commission_agent_sell',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'delete_sell_payment', in_array('delete_sell_payment',
            $role_permissions), ['class' => 'input-icheck']); !!}
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'access_types_of_service', in_array('access_types_of_service',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'access_own_sell_return', in_array('access_own_sell_return',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'edit_invoice_number', in_array('edit_invoice_number',
            $role_permissions),
  ...
  <div class="row check_group align-items-center">
    ...
    <div class="col-xs-12 col-md-7">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[quotation_view]', 'quotation.view_all', in_array('quotation.view_all',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[quotation_view]', 'quotation.view_own', in_array('quotation.view_own',
            $role_permissions),
  ...
  <div class="row check_group align-items-center">
    ...
    <div class="col-xs-12 col-md-7">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[shipping_view]', 'access_shipping', in_array('access_shipping',
            $role_permissions), ['class' => 'input-icheck']); !!}
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[shipping_view]', 'access_own_shipping', in_array('access_own_shipping',
            $role_permissions), ['class' => 'input-icheck']); !!}
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'access_pending_shipments_only',
            in_array('access_pending_shipments_only', $role_permissions), ['class' => 'input-icheck']); !!}
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            ...
            in_array('access_commission_agent_shipping', $role_permissions), ['class' => 'input-icheck']); !!}
  ...
  <div class="row check_group align-items-center">
    ...
    <div class="col-xs-12 col-md-7">
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'close_cash_register', in_array('close_cash_register',
            $role_permissions),
  ...
  <div class="row check_group align-items-center">
    ...
    <div class="col-xs-12 col-md-7">
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'purchase_n_sell_report.view', in_array('purchase_n_sell_report.view',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'contacts_report.view', in_array('contacts_report.view',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'trending_product_report.view', in_array('trending_product_report.view',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'view_product_stock_value', in_array('view_product_stock_value',
            $role_permissions),
  ...
  <div class="row check_group align-items-center">
    ...
    <div class="col-xs-12 col-md-7">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[expense_view]', 'all_expense.access', in_array('all_expense.access',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[expense_view]', 'view_own_expense', in_array('view_own_expense',
            $role_permissions),['class' => 'input-icheck']); !!}
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'edit_account_transaction', in_array('edit_account_transaction',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'delete_account_transaction', in_array('delete_account_transaction',
            $role_permissions),
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[bookings_view]', 'crud_all_bookings', in_array('crud_all_bookings',
            $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[bookings_view]', 'crud_own_bookings', in_array('crud_own_bookings',
            $role_permissions),
  ...
  <div class="row">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'access_default_selling_price', in_array('access_default_selling_price',
            $role_permissions),
  ...
  <div class="row">
    <div class="col-md-12 text-center">
      <button type="submit" style='background-color: #24695c; border: none;'
        class="tw-dw-btn tw-dw-btn-md text-white">@lang(
        'messages.update'
        )</button>
    </div>
  </div>
...
@push('styles')
<style>
/* Role create/edit uses iCheck markup (from default templates).
           Viho theme also draws checkbox boxes via `.checkbox label::before/::after`,
           which results in a "double checkbox" look.
           Disable Viho pseudo-checkboxes only for this page. */
.viho-icheck-reset .checkbox label::before,
.viho-icheck-reset .checkbox label::after {
