    ...
    <section class="content no-print">
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-sm-12 col-md-6 col-xl-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span
                                    class="input-group-addon d-flex align-items-center justify-content-center flex-nowrap">
            ...
            @component('components.widget', ['class' => 'box-solid'])
                ...
                <div class="col-12 text-center">
                    <button type="button" class="tw-dw-btn tw-dw-btn-primary tw-dw-btn-sm text-white"
                        ...
                        style="background-color: #24695C !important; border-color: #24695C !important;"> <i
        ...
        <div class="row">
            ...
            <div class="col-sm-12 text-center tw-mt-4">
                <button type="button" id="submit-sell" class="tw-dw-btn tw-dw-btn-primary tw-dw-btn-md text-white"
                    style="background-color: #24695C !important; border-color: #24695C !important;">@lang('messages.save')</button>
                <button type="button" id="save-and-print"
                    class="tw-dw-btn tw-dw-btn-success tw-dw-btn-md text-white"
                    style="background-color: #24695C !important; border-color: #24695C !important;">@lang('lang_v1.save_and_print')</button>
            </div>
        </div>
        ...
        {!! Form::close() !!}
        <iframe id="invoice_print_frame" name="invoice_print_frame" style="position:absolute;width:0;height:0;border:0;visibility:hidden;"></iframe>
    </section>
