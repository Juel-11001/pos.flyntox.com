            ...
            <div class="row">
              ...
              <div class="col-sm-12 col-md-6 col-xl-4 col-xxl-3">
                <div class="form-group">
                  ...
                  {!! Form::select('sell_list_filter_payment_status', ['paid' => __('lang_v1.paid'), 'due' =>
                  __('lang_v1.due'),
                  'partial' => __('lang_v1.partial'), 'overdue' => __('lang_v1.overdue')], null, ['class' =>
              ...
              <div class="col-sm-12 col-md-6 col-xl-4 col-xxl-3">
                <div class="form-group">
                  ...
                  {!! Form::select('created_by', $sales_representative, null, ['class' => 'form-control select2',
                  'style' =>
                  'width:100%']); !!}
                </div>
              </div>
              ...
              <div class="col-sm-12 col-md-6 col-xl-4 col-xxl-3">
                <div class="form-group">
                  ...
                  {!! Form::select('sales_cmsn_agnt', $commission_agents, null, ['class' => 'form-control select2',
                  'style' =>
                  'width:100%']); !!}
                </div>
              </div>
              ...
              <div class="col-sm-12 col-md-6 col-xl-4 col-xxl-3">
                <div class="form-group">
                  ...
                  {!! Form::select('shipping_status', $shipping_statuses, null, ['class' => 'form-control select2',
                  'style' =>
                  'width:100%', 'placeholder' => __('lang_v1.all')]); !!}
                </div>
              </div>
  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a class="btn btn-primary btn-sm" href="{{ route('ai-template.sells.create') }}">
