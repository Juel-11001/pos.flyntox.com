<div class="modal-dialog" role="document">
  <div class="modal-content">
    {!! Form::open(['url' => route('ai-template.expenses.store'), 'method' => 'post', 'id' => 'add_expense_modal_form',
    'files' => true ]) !!}
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            'placeholder' => __('messages.please_select'), 'required', 'id' => 'expense_location_id'], $bl_attributes);
            !!}
          </div>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            {!! Form::select('expense_sub_category_id', [], null, ['placeholder' => __('messages.please_select'),
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              'required', 'id' => 'expense_transaction_date']); !!}
            </div>
          </div>
        </div>
        <div class="clearfix"></div>
        <div class="col-sm-6">
          <div class="form-group">
            ...
            {!! Form::select('expense_for', $users, null, ['class' => 'form-control select2', 'placeholder' =>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::select('tax_id', $taxes['tax_rates'], null, ['class' => 'form-control', 'id'=>'expense_tax_id'],
              $taxes['attributes']); !!}
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            {!! Form::text('final_total', null, ['class' => 'form-control input_number', 'placeholder' =>
            __('sale.total_amount'), 'required', 'id' => 'expense_final_total']); !!}
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            {!! Form::label('expense_additional_notes', __('expense.expense_note') . ':') !!}
            {!! Form::textarea('additional_notes', null, ['class' => 'form-control', 'rows' => 3, 'id' =>
            'expense_additional_notes']); !!}
          </div>
        </div>
      </div>
