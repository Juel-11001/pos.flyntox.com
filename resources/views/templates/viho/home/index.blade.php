...
@section('content')
    @php
        $is_viho_template = request()->segment(1) === 'ai-template';
    @endphp
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right mb-0">
                            ...
                            <li class="breadcrumb-item active">{{ __('home.home') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    @if (auth()->user()->can('dashboard.data'))
                        @if ($is_admin)
                            <div class="tw-grid tw-grid-cols-1 tw-gap-4 tw-mt-2 sm:tw-grid-cols-2 xl:tw-grid-cols-4 sm:tw-gap-5">
                                ...
                                <div
                                    class="dashboard-metric-card tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm hover:tw-shadow-md tw-rounded-xl hover:tw--translate-y-0.5 tw-ring-1 tw-ring-gray-200">
                                    <div class="tw-p-4 sm:tw-p-5">
                                        <div class="tw-flex tw-items-center tw-gap-4">
                                            <div
                ...
                <div class="tw-relative">
                    ...
                    <div class="tw-px-5 tw-isolate">
                        <div
                            ...
                            <div
                                class="dashboard-metric-card tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm tw-rounded-xl hover:tw-shadow-md hover:tw--translate-y-0.5 tw-ring-1 tw-ring-gray-200">
                                <div class="tw-p-4 sm:tw-p-5">
                                    <div class="tw-flex tw-items-center tw-gap-4">
                                        <div
        ...
        $(document).ready(function() {
            ...
            @if (auth()->user()->can('account.access') && config('constants.show_payments_recovered_today') == true)
                ...
                cash_flow_table = $('#cash_flow_table').DataTable({
                    ...
                    fixedHeader:false,
                    "ajax": {
                        "url": "{{ route('ai-template.account.cash-flow') }}",
                        "data": function(d) {
                            d.type = 'credit';
