...
@endphp
@can('category.create')
	<button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm pull-right btn-modal" data-href="{{ route('ai-template.taxonomies.create', ['type' => $category_type]) }}" data-container=".category_modal">
