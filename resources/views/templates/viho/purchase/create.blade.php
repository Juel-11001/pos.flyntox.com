...
<section class="content-header">
  <div class="tw-flex tw-justify-between tw-items-center">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black use_ai_btn">@lang('purchase.add_purchase') <i
        ...
        data-placement="bottom" data-content="@include('templates.viho.purchase.partials.keyboard_shortcuts_details')"
...
<section class="content">
  ...
  {!! Form::open(['url' => route($route_prefix . 'purchases.store'), 'method' => 'post', 'id' => 'add_purchase_form',
  'files' => true ]) !!}
  @component('components.widget', ['class' => 'box-primary'])
  <div class="row">
    <div class="@if(!empty($default_purchase_status)) @else col-sm-12 col-md-6 col-xl-4 col-xxl-3 @endif">
    ...
    <div class="col-sm-12 col-md-6 col-xl-4 col-xxl-3 @if(!empty($default_purchase_status)) hide @endif">
      <div class="form-group">
    ...
    <div class="col-sm-12 col-md-6 col-xl-4 col-xxl-3">
      <div class="form-group">
        ...
        'placeholder' => __('messages.please_select'), 'required'], $bl_attributes); !!}
      </div>
    </div>

    <!-- Currency Exchange Rate -->
    <div class="col-sm-12 col-md-6 col-xl-4 col-xxl-3 @if(!$currency_details->purchase_in_diff_currency) hide @endif">
      <div class="form-group">
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        {!! Form::text('custom_field_1', null, ['class' => 'form-control','placeholder' => $custom_field_1_label,
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        {!! Form::text('custom_field_2', null, ['class' => 'form-control','placeholder' => $custom_field_2_label,
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        {!! Form::text('custom_field_3', null, ['class' => 'form-control','placeholder' => $custom_field_3_label,
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        {!! Form::text('custom_field_4', null, ['class' => 'form-control','placeholder' => $custom_field_4_label,
    ...
    <div class="col-sm-12 col-md-8 col-lg-6">
      <div class="form-group">
        <div class="input-group">
          ...
          'placeholder' => __('lang_v1.search_product_placeholder'), 'disabled' => $search_disable]); !!}
        </div>
      </div>
    </div>
    ...
    <div class="col-sm-12">
      <div class="d-flex w-100 overflow-auto">
        <table class="table table-condensed table-bordered table-th-green text-center table-striped"
          id="purchase_entry_table" style="min-width: 700px">
          <thead>
            <tr>
              <th>#</th>
      ...
      <div class='row'>
        <div class="col-sm-12 col-md-4">
          <div class="form-group">
            ...
            <br>
            {!! Form::select('discount_type', [ '' => __('lang_v1.none'), 'fixed' => __( 'lang_v1.fixed' ), 'percentage'
            => __( 'lang_v1.percentage' )], '', ['class' => 'form-control select2']); !!}
          </div>
        </div>
        <div class="col-sm-12 col-md-4">
          <div class="form-group">
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        {!! Form::text('shipping_custom_field_1', null, ['class' => 'form-control','placeholder' =>
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        {!! Form::text('shipping_custom_field_2', null, ['class' => 'form-control','placeholder' =>
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        {!! Form::text('shipping_custom_field_3', null, ['class' => 'form-control','placeholder' =>
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        {!! Form::text('shipping_custom_field_4', null, ['class' => 'form-control','placeholder' =>
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        {!! Form::text('shipping_custom_field_5', null, ['class' => 'form-control','placeholder' =>
