<div class="pos-tab-content active">
  <div class="row">
    ...
    <div class="col-sm-12 col-lg-6 col-xl-4">
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          {!! Form::text('start_date', @format_date($business->start_date), ['class' => 'form-control
    ...
    <div class="col-sm-12 col-lg-6 col-xl-4">
      <div class="form-group">
        ...
        @show_tooltip(__('tooltip.default_profit_percent'))
        <div class="input-group">
          <span class="input-group-addon">
            <i class="fa fa-plus-circle"></i>
          </span>
          {!! Form::text('default_profit_percent', @num_format($business->default_profit_percent), ['class' =>
    ...
    <div class="col-sm-12 col-lg-6 col-xl-4">
      <div class="form-group">
        ...
        <div class="input-group flex-nowrap">
          ...
          {!! Form::select('currency_id', $currencies, $business->currency_id, ['class' => 'form-control
          select2','placeholder' => __('business.currency'), 'required']); !!}
        </div>
      </div>
    </div>
    <div class="col-sm-12 col-lg-6 col-xl-4">
      <div class="form-group">
        ...
        {!! Form::select('currency_symbol_placement', ['before' => __('lang_v1.before_amount'), 'after' =>
        __('lang_v1.after_amount')], $business->currency_symbol_placement, ['class' => 'form-control select2',
        'required']); !!}
      </div>
    </div>
    <div class="col-sm-12 col-lg-6 col-xl-4">
      <div class="form-group">
        ...
        <div class="input-group flex-nowrap">
          ...
          {!! Form::select('time_zone', $timezone_list, $business->time_zone, ['class' => 'form-control select2',
          'required']); !!}
        </div>
      </div>
    </div>
    ...
    <div class="col-sm-12 col-lg-6 col-xl-4">
      <div class="form-group">
        ...
        <div class="input-group flex-nowrap">
          ...
          {!! Form::select('fy_start_month', $months, $business->fy_start_month, ['class' => 'form-control select2',
          'required']); !!}
        </div>
      </div>
    </div>
    <div class="col-sm-12 col-lg-6 col-xl-4">
      <div class="form-group">
        ...
        <div class="input-group flex-nowrap">
          ...
          {!! Form::select('accounting_method', $accounting_methods, $business->accounting_method, ['class' =>
    ...
    <div class="col-sm-12 col-lg-6 col-xl-4">
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          {!! Form::number('transaction_edit_days', $business->transaction_edit_days, ['class' =>
    ...
    <div class="col-sm-12 col-lg-6 col-xl-4">
      <div class="form-group">
        ...
        <div class="input-group flex-nowrap">
          ...
          {!! Form::select('date_format', $date_formats, $business->date_format, ['class' => 'form-control select2',
          'required']); !!}
        </div>
      </div>
    </div>
    <div class="col-sm-12 col-lg-6 col-xl-4">
      <div class="form-group">
        ...
        <div class="input-group flex-nowrap">
          ...
          {!! Form::select('time_format', [12 => __('lang_v1.12_hour'), 24 => __('lang_v1.24_hour')],
          $business->time_format, ['class' => 'form-control select2', 'required']); !!}
        </div>
      </div>
    </div>
    ...
    <div class="col-sm-12 col-lg-6 col-xl-4">
      <div class="form-group">
        ...
        @show_tooltip(__('lang_v1.currency_precision_help'))
        {!! Form::select('currency_precision', [0 =>0, 1=>1, 2=>2, 3=>3,4=>4], $business->currency_precision, ['class'
        => 'form-control select2', 'required']); !!}
      </div>
    </div>
    <div class="col-sm-12 col-lg-6 col-xl-4">
      <div class="form-group">
        ...
        @show_tooltip(__('lang_v1.quantity_precision_help'))
        {!! Form::select('quantity_precision', [0 =>0, 1=>1, 2=>2, 3=>3,4=>4], $business->quantity_precision, ['class'
        => 'form-control select2', 'required']); !!}
      </div>
    </div>
  </div>
  ...
  <div class="row hide">
    <div class="col-sm-8">
      <div class="form-group">
        <label>
          {!! Form::checkbox('common_settings[is_enabled_export]', true, !empty($common_settings['is_enabled_export']) ?
          true : false ,
