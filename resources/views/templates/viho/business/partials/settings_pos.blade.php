      ...
      <table class="table table-striped">
        ...
        <tr>
          ...
          <td>
            ...
            !empty($shortcuts["pos"]["express_checkout"]) ? $shortcuts["pos"]["express_checkout"] : null, ['class' =>
            'form-control']); !!}
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            {!! Form::text('shortcuts[pos][draft]', !empty($shortcuts["pos"]["draft"]) ? $shortcuts["pos"]["draft"] :
        ...
        <tr>
          ...
          <td>
            {!! Form::text('shortcuts[pos][cancel]', !empty($shortcuts["pos"]["cancel"]) ? $shortcuts["pos"]["cancel"] :
            null, ['class' => 'form-control']); !!}
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            {!! Form::text('shortcuts[pos][weighing_scale]', !empty($shortcuts["pos"]["weighing_scale"]) ?
