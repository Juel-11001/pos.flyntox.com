<div class="pos-tab-content">
  <div class="row">
    ...
    <div class="col-sm-12 col-lg-6 col-xl-4">
      <div class="form-group">
        {!! Form::label('layout_template', __('lang_v1.layout_template') . ':') !!}
        {!! Form::select('common_settings[layout_template]', $layout_templates,
        !empty($common_settings['layout_template']) ? $common_settings['layout_template'] : 'default', ['class' =>
        'form-control select2', 'style' => 'width: 100%;', 'id' => 'layout_template']) !!}
      </div>
    </div>
    <div class="col-sm-12 col-lg-6 col-xl-4">
      <div class="form-group">
        ...
        $page_entries,
        !empty($common_settings['default_datatable_page_entries']) ? $common_settings['default_datatable_page_entries']
        : 25,
