  ...
  <div class="row">
    <div class="col-sm-3">
      <div class="form-group">
        ...
        {!! Form::text('weighing_scale_setting[label_prefix]', isset($weighing_scale_setting['label_prefix']) ?
        $weighing_scale_setting['label_prefix'] : null, ['class' => 'form-control', 'id' => 'label_prefix']); !!}
      </div>
    </div>
    ...
    <div class="col-sm-3">
      <div class="form-group">
        ...
        ['class'
        => 'form-control select2', 'style' => 'width: 100%;', 'id' => 'product_sku_length']); !!}
      </div>
    </div>
    ...
    <div class="col-sm-3">
      <div class="form-group">
        ...
        {!! Form::select('weighing_scale_setting[qty_length]', [1,2,3,4,5], isset($weighing_scale_setting['qty_length'])
        ?
        $weighing_scale_setting['qty_length'] : 3, ['class' => 'form-control select2', 'style' => 'width: 100%;', 'id'
        =>
        'qty_length']); !!}
      </div>
    </div>
    ...
    <div class="col-sm-3">
      <div class="form-group">
        ...
        ['class'
        => 'form-control select2', 'style' => 'width: 100%;', 'id' => 'qty_length_decimal']); !!}
      </div>
    </div>
  </div>
</div>