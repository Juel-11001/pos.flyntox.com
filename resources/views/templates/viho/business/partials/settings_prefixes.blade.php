<div class="pos-tab-content">
  <div class="row">
    ...
    <div class="col-sm-12 col-lg-6 col-xl-4">
      <div class="form-group">
        @php
        $purchase_requisition_prefix = !empty($business->ref_no_prefixes['purchase_requisition']) ?
        $business->ref_no_prefixes['purchase_requisition'] : '';
        @endphp
        {!! Form::label('ref_no_prefixes[purchase_requisition]', __('lang_v1.purchase_requisition') . ':') !!}
        {!! Form::text('ref_no_prefixes[purchase_requisition]', $purchase_requisition_prefix, ['class' =>
        'form-control']); !!}
      </div>
    </div>
    <div class="col-sm-12 col-lg-6 col-xl-4">
      <div class="form-group">
        @php
        $purchase_order_prefix = !empty($business->ref_no_prefixes['purchase_order']) ?
        $business->ref_no_prefixes['purchase_order'] : '';
        @endphp
    ...
    <div class="col-sm-12 col-lg-6 col-xl-4">
      <div class="form-group">
        @php
        $subscription_prefix = !empty($business->ref_no_prefixes['subscription']) ?
        $business->ref_no_prefixes['subscription'] : '';
        @endphp
    ...
    <div class="col-sm-12 col-lg-6 col-xl-4">
      <div class="form-group">
        @php
        $sales_order_prefix = !empty($business->ref_no_prefixes['sales_order']) ?
        $business->ref_no_prefixes['sales_order'] : '';
        @endphp
