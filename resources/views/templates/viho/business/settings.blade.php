...
<section class="content">
  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <div class="row">
        <div class="col-sm-12 col-md-4 col-xl-3 pos-tab-menu tw-rounded-lg">
          <div class="list-group">
            ...
            <a href="#"
              class="list-group-item text-center tw-font-bold tw-text-sm md:tw-text-base">@lang('lang_v1.display_screen')</a>
            <a href="#"
        ...
        <div class="col-sm-12 col-md-8 col-xl-9 pos-tab">
          <!-- tab 1 start -->
          @include('templates.viho.business.partials.settings_business')
          <!-- tab 1 end -->
          <!-- tab 2 start -->
          @include('templates.viho.business.partials.settings_tax')
          <!-- tab 2 end -->
          <!-- tab 3 start -->
          @include('templates.viho.business.partials.settings_product')

          @include('templates.viho.business.partials.settings_contact')
          <!-- tab 3 end -->
          <!-- tab 4 start -->
          @include('templates.viho.business.partials.settings_sales')
          @include('templates.viho.business.partials.settings_pos')
          @include('templates.viho.business.partials.settings_display_pos')
          <!-- tab 4 end -->
          <!-- tab 5 start -->
          @include('templates.viho.business.partials.settings_purchase')

          @include('templates.viho.business.partials.settings_payment')
          <!-- tab 5 end -->
          <!-- tab 6 start -->
          @include('templates.viho.business.partials.settings_dashboard')
          <!-- tab 6 end -->
          <!-- tab 7 start -->
          @include('templates.viho.business.partials.settings_system')
          <!-- tab 7 end -->
          <!-- tab 8 start -->
          @include('templates.viho.business.partials.settings_prefixes')
          <!-- tab 8 end -->
          <!-- tab 9 start -->
          @include('templates.viho.business.partials.settings_email')
          <!-- tab 9 end -->
          <!-- tab 10 start -->
          @include('templates.viho.business.partials.settings_sms')
          <!-- tab 10 end -->
          <!-- tab 11 start -->
          @include('templates.viho.business.partials.settings_reward_point')
          <!-- tab 11 end -->
          <!-- tab 12 start -->
          @include('templates.viho.business.partials.settings_modules')
          <!-- tab 12 end -->
          @include('templates.viho.business.partials.settings_custom_labels')
        </div>
      </div>
      @endcomponent
      {{-- </div> --}}
  ...
  <div class="row">
    <div class="col-sm-12 text-center">
      <button class="tw-dw-btn tw-dw-btn-error tw-dw-btn-md text-white"
...
$(document).ready(function() {
  ...
  $('#test_sms_btn').click(function() {
    ...
    if (test_number.trim() == '') {
      toastr.error('{{ __('
        lang_v1.test_number_is_required ') }}');
      $('#test_number').focus();
