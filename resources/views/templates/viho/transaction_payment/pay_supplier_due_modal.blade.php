<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
  <div class="modal-content" style='max-height: auto; border: 5px solid #ccc;'>

    {!! Form::open(['url' => action([\App\Http\Controllers\TransactionPaymentController::class, 'postPayContactDue']),
    'method' => 'post', 'id' => 'pay_contact_due_form', 'files' => true ]) !!}
    ...
    <div class="modal-body">
      ...
      @if(config('constants.show_payment_type_on_contact_pay') && ($due_payment_type == 'purchase' || $due_payment_type
      == 'sell'))
      @php
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="form-group">
            ...
            {!! Form::select("is_reverse", $reverse_payment_types, 0, ['class' => 'form-control select2', 'style' =>
            'width:100%;']); !!}
          </div>
        </div>
      </div>
      ...
      <div class="row payment_row">
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              payment_amount', 'required', 'placeholder' => __('sale.amount'), 'data-rule-max-value' =>
              $payment_line->amount, 'data-msg-max-value' => __('lang_v1.max_amount_to_be_paid_is', ['amount' =>
              $amount_formated])]); !!}
              @else
              {!! Form::text("amount", @num_format($payment_line->amount), ['class' => 'form-control input_number
              payment_amount', 'required', 'placeholder' => __('sale.amount')]); !!}
              @endif
            </div>
          </div>
        </div>
        ...
        !empty($pos_settings['enable_cash_denomination_for_payment_methods']) ?
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            {!! Form::file('document', ['accept' => implode(',',
    ...
    <div class="modal-footer">
      ...
      <button type="button" class="tw-dw-btn tw-dw-btn-neutral tw-text-white" data-bs-dismiss="modal">@lang(
