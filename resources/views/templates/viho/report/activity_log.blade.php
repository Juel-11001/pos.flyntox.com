      ...
      <div class="row">
        <div class="col-sm-12 col-md-6 col-xl-4 col-xxl-3">
          <div class="form-group">
            ...
            {!! Form::select('al_users_filter', $users, null, ['class' => 'form-control select2', 'style' =>
            'width:100%',
            'id' => 'al_users_filter', 'placeholder' => __('lang_v1.all')]); !!}
          </div>
        </div>
        ...
        <div class="col-sm-12 col-md-6 col-xl-4 col-xxl-3">
          <div class="form-group">
            ...
            {!! Form::select('subject_type', $transaction_types, null, ['class' => 'form-control select2', 'style' =>
            'width:100%', 'id' => 'subject_type', 'placeholder' => __('lang_v1.all')]); !!}
          </div>
        </div>
        ...
        <div class="col-sm-12 col-md-6 col-xl-4 col-xxl-3">
          <div class="form-group">
            ...
            {!! Form::text('al_date_filter', null, ['placeholder' => __('lang_v1.select_a_date_range'), 'class' =>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="d-flex w-100 overflow-auto">
        <table class="table table-bordered table-striped" id="activity_log_table" style="min-width: 800px;">
          <thead>
            <tr>
