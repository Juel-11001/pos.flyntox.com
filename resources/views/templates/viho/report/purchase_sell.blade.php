    ...
    <div class="row">
      <div class="col-sm-6">
        <h3>@lang('report.purchase_sell')
          <small
            class="tw-text-sm md:tw-text-base tw-text-gray-700 tw-font-semibold">@lang('report.purchase_sell_msg')</small>
        </h3>
      </div>
    </div>
  </div>
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-sm-12 col-lg-6">
            ...
            <table class="table table-striped">
              <tr>
                <th>@lang('report.total_purchase'):<br><small class="text-muted">(@lang('product.exc_of_tax'),
                    @lang('sale.discount'))</small></th>
                <td><span class="display_currency total_purchase" data-currency_symbol="true"></span></td>
              </tr>
              <tr>
                <th>@lang('report.purchase_inc_tax'):<br><small class="text-muted">(@lang('product.inc_of_tax'))</small>
                </th>
              ...
              <tr>
                <th>@lang('lang_v1.total_purchase_return_inc_tax'):<br><small
                    class="text-muted">(@lang('product.inc_of_tax'))</small></th>
          ...
          <div class="col-sm-12 col-lg-6">
            ...
            <table class="table table-striped">
              <tr>
                <th>@lang('report.total_sell'):<br><small class="text-muted">(@lang('product.exc_of_tax'),
                    @lang('sale.discount'))</small></th>
                <td><span class="display_currency total_sell" data-currency_symbol="true"></span></td>
              </tr>
              <tr>
                <th>@lang('report.sell_inc_tax'):<br><small class="text-muted">(@lang('product.inc_of_tax'))</small>
                </th>
                <td><span class="display_currency sell_inc_tax" data-currency_symbol="true"></span></td>
              </tr>
              <tr>
                <th>@lang('lang_v1.total_sell_return_inc_tax'):<br><small
                    class="text-muted">(@lang('product.inc_of_tax'))</small></th>
        ...
        <div class="row">
          <div class="col-sm-12 col-lg-8">
            @component('components.widget', ['title' => __('lang_v1.overall') . ' ((' . __('business.sale') . ' - ' .
            __('lang_v1.sell_return') . ') - (' . __('lang_v1.purchase') . ' - ' . __('lang_v1.purchase_return') .
            '))'])
            <table class="table table-striped">
              <tr>
