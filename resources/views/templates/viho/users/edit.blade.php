...
<div class="row">
  <div class="col-sm-12">
    <div class="card">
      ...
      <div class="card-body">
        {!! Form::model($user, ['url' => route('ai-template.users.update', [$user->id]), 'method' => 'PUT', 'id' =>
        'user_edit_form']) !!}
        <div class="row">
          <div class="col-md-2">
          ...
          <div class="col-md-4">
            <div class="form-group">
              <div class="checkbox checkbox-primary m-t-15">
                {!! Form::checkbox('is_enable_service_staff_pin', 1, $user->is_enable_service_staff_pin, ['id' =>
          ...
          <div class="col-md-4 {{ $user->is_enable_service_staff_pin ? '' : 'hide' }} service_staff_pin_div"
            ...
            <div class="form-group">
              ...
              {!! Form::password('service_staff_pin', ['class' => 'form-control', 'placeholder' =>
              __('lang_v1.staff_pin')]) !!}
            </div>
          </div>
        </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="input-group">
                  {!! Form::text('username', str_replace($username_ext, '', $user->username), ['class' =>
                  'form-control', 'placeholder' => __('business.username')]) !!}
            ...
            <div class="row">
              <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="checkbox checkbox-primary m-t-15">
                  ...
                  $permitted_locations == 'all', ['id' => 'access_all_locations']) !!}
              ...
              <div class="col-md-4">
                ...
                <div class="checkbox checkbox-primary m-t-15">
                  {!! Form::checkbox('location_permissions[]', 'location.' . $location->id,
                  is_array($permitted_locations) && in_array($location->id, $permitted_locations), ['id' =>
        ...
        <div class="row mt-4">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              {!! Form::text('cmmsn_percent', @num_format($user->cmmsn_percent), ['class' => 'form-control
              input_number', 'placeholder' => __('lang_v1.cmmsn_percent')]) !!}
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              ...
              {!! Form::text('max_sales_discount_percent', @num_format($user->max_sales_discount_percent), ['class' =>
              'form-control input_number', 'placeholder' => __('lang_v1.max_sales_discount_percent')]) !!}
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
          ...
          <div class="col-sm-4 {{ $user->selected_contacts ? '' : 'hide' }} selected_contacts_div mt-3">
            <div class="form-group">
              ...
              {!! Form::select('selected_contact_ids[]', $contact_access, array_keys($contact_access), ['class' =>
              'form-control select2', 'multiple', 'style' => 'width: 100%;', 'id' => 'user_allowed_contacts']) !!}
            </div>
          </div>
        </div>
