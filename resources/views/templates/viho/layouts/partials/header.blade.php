        ...
        <div class="tw-flex tw-items-start tw-justify-between tw-gap-6 lg:tw-items-center">
            ...
            <div class="tw-flex tw-flex-wrap tw-items-center tw-justify-end tw-gap-3">
                ...
                @can('business_settings.access')
                    <details class="tw-dw-dropdown tw-relative tw-inline-block tw-text-left">
                        <summary
                            ...
                            {{ $layout_templates[$active_layout_template] ?? ucfirst($active_layout_template) }}
                        </summary>
                ...
                @if (in_array('pos_sale', $enabled_modules))
                    @can('sell.create')
                        <a href="{{ route('ai-template.pos.create') }}"
                            class="sm:tw-inline-flex tw-transition-all tw-duration-200 tw-gap-2 tw-bg-{{ $theme_color }}-800 hover:tw-bg-{{ $theme_color }}-700 tw-py-1.5 tw-px-3 tw-rounded-lg tw-items-center tw-justify-center tw-text-sm tw-font-medium tw-ring-1 tw-ring-white/10 hover:tw-text-white tw-text-white">
                ...
                <button type="button"
                    class="tw-hidden lg:tw-inline-flex tw-transition-all tw-ring-1 tw-ring-white/10 tw-duration-200 tw-bg-{{ $theme_color }}-800 hover:tw-bg-{{ $theme_color }}-700 tw-py-1.5 tw-px-3 tw-rounded-lg tw-items-center tw-justify-center tw-text-sm tw-font-medium tw-text-white hover:tw-text-white tw-font-mono">
                    {{ @format_date('now') }}
                </button>
                ...
                <details class="tw-dw-dropdown tw-relative tw-inline-block tw-text-left">
                    <summary data-toggle="popover"
                        ...
                        <span class="tw-block">{{ Auth::User()->first_name }}
