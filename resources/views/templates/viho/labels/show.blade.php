    ...
    <div class="col-sm-8 col-sm-offset-2">
      <div class="form-group">
        <div class="input-group flex-nowrap">
          ...
          {!! Form::text('search_product', null, ['class' => 'form-control', 'id' => 'search_product_for_label',
          'placeholder' => __('lang_v1.enter_product_name_to_print_labels'), 'autofocus']); !!}
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-sm-10">
      <div class="d-flex overflow-auto w-100">
        <table class="table table-bordered table-striped table-condensed" id="product_table" style="min-width: 600px;">
          <thead>
            <tr>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="w-100 overflow-auto d-flex">
        <table class="table table-bordered label-print-settings-table" style="min-width: 600px;">
          <tr>
            <td>
              <div class="checkbox">
                <label>
            ...
            <td>
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('print[price]', 1, true, ['id' => 'is_show_price']) !!} <b>@lang(
          ...
          <tr>
            ...
            <td>
              ...
              <div class="checkbox">
                <label>
                  <input type="checkbox" checked name="print[exp_date]" value="1"> <b>@lang( 'lang_v1.print_exp_date'
                    )</b>
                </label>
              </div>
          ...
          <tr>
            ...
            $product_cf_details[$loop->iteration]['type'] : 'text';
            $dropdown = !empty($product_cf_details[$loop->iteration]['dropdown_options']) ? explode(PHP_EOL,
    ...
    <div class="col-sm-4">
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          {!! Form::select('barcode_setting', $barcode_settings, !empty($default) ? $default->id : null, ['class' =>
          'form-control']); !!}
        </div>
      </div>
    </div>
