            ...
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                @can('sell.create')
                    <a class="btn btn-primary btn-sm d-inline-flex align-items-center gap-1"
                        href="{{ route('ai-template.pos.create') }}">
            ...
            <div class="card-body">
                ...
                @can('sell.view')
                    ...
                    <div class="table-responsive">
                        @include('templates.viho.sale_pos.partials.sales_table')
                    </div>
...
@section('javascript')
    @include('templates.viho.templates.viho.sale_pos.partials.sale_table_javascript')
