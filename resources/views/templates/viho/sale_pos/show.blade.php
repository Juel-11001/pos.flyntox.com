...
<div class="modal-body">
    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-xs-12">
        <div class="table-responsive">
          @include('templates.viho.sale_pos.partials.sale_line_details')
        </div>
      </div>
    </div>
    <div class="row">
  ...
  <div class="modal-footer">
    @if($sell->type != 'sales_order')
    <a href="#" class="print-invoice-window tw-dw-btn tw-dw-btn-success tw-text-white" data-href="{{route('sell.printInvoice', [$sell->id])}}?package_slip=true"><i class="fas fa-file-alt" aria-hidden="true"></i> @lang("lang_v1.packing_slip")</a>
    @endif
    @can('print_invoice')
      <a href="#" class="print-invoice-window tw-dw-btn tw-dw-btn-primary tw-text-white" data-href="{{route('sell.printInvoice', [$sell->id])}}"><i class="fa fa-print" aria-hidden="true"></i> @lang("lang_v1.print_invoice")</a>
    @endcan
