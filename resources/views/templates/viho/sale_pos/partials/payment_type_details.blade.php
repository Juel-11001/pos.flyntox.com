    ...
    <div class="row g-3">
        <div class="col-md-4">
            <div class="form-group mb-0">
                {!! Form::label("card_number_$row_index", __('lang_v1.card_no'), ['class' => 'form-label fw-bold']) !!}
        ...
        <div class="col-md-4">
            <div class="form-group mb-0">
                {!! Form::label("card_holder_name_$row_index", __('lang_v1.card_holder_name'), ['class' => 'form-label fw-bold']) !!}
        ...
        <div class="col-md-4">
            <div class="form-group mb-0">
                {!! Form::label("card_transaction_number_$row_index",__('lang_v1.card_transaction_no'), ['class' => 'form-label fw-bold']) !!}
        ...
        <div class="col-md-3">
            <div class="form-group mb-0">
                {!! Form::label("card_type_$row_index", __('lang_v1.card_type'), ['class' => 'form-label fw-bold']) !!}
        ...
        <div class="col-md-3">
            <div class="form-group mb-0">
                {!! Form::label("card_month_$row_index", __('lang_v1.month'), ['class' => 'form-label fw-bold']) !!}
        ...
        <div class="col-md-3">
            <div class="form-group mb-0">
                {!! Form::label("card_year_$row_index", __('lang_v1.year'), ['class' => 'form-label fw-bold']) !!}
        ...
        <div class="col-md-3">
            <div class="form-group mb-0">
                {!! Form::label("card_security_$row_index",__('lang_v1.security_code'), ['class' => 'form-label fw-bold']) !!}
...
<div class="payment_details_div @if( $payment_line['method'] !== 'cheque' ) {{ 'hide' }} @endif mt-2" data-type="cheque" >
    <div class="row">
        <div class="col-md-12">
            <div class="form-group mb-0">
                {!! Form::label("cheque_number_$row_index",__('lang_v1.cheque_no'), ['class' => 'form-label fw-bold']) !!}
...
<div class="payment_details_div @if( $payment_line['method'] !== 'bank_transfer' ) {{ 'hide' }} @endif mt-2" data-type="bank_transfer" >
    <div class="row">
        <div class="col-md-12">
            <div class="form-group mb-0">
                {!! Form::label("bank_account_number_$row_index",__('lang_v1.bank_account_number'), ['class' => 'form-label fw-bold']) !!}
...
@for ($i = 1; $i < 8; $i++)
<div class="payment_details_div @if( $payment_line['method'] !== 'custom_pay_' . $i ) {{ 'hide' }} @endif mt-2" data-type="custom_pay_{{$i}}" >
    <div class="row">
        <div class="col-md-12">
            <div class="form-group mb-0">
                {!! Form::label("transaction_no_{$i}_{$row_index}", __('lang_v1.transaction_no'), ['class' => 'form-label fw-bold']) !!}
