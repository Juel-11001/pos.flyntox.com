  ...
  <div class="col-md-12">
    <table class="table table-condensed">
      ...
      <tr>
        ...
        <td @if(!Gate::check('disable_discount') || auth()->user()->can('superadmin') || auth()->user()->can('admin'))
          class="" @else class="hide" @endif>
        ...
        <td>
          <span class="tw-text-base md:tw-text-lg tw-font-semibold">
            ...
            <i class="fas fa-edit cursor-pointer" title="@lang('sale.shipping')" aria-hidden="true" data-toggle="modal"
