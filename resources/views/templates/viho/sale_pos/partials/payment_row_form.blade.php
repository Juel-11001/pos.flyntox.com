  ...
  <div class="{{$col_class}}">
    <div class="form-group">
      ...
      <div class="input-group">
        ...
        col-md-12 payment_types_dropdown', 'required', 'id' => !$readonly ? "method_$row_index" :
        "method_advance_$row_index", 'style' => 'width:100%;', 'disabled' => $readonly]); !!}
    ...
    <table class="table table-slim">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{!! Form::number("payment[$row_index][denominations][$dnm]", $count, ['class' => 'form-control
            cash_denomination input-sm', 'min' => 0, 'data-denomination' => $dnm, 'style' => 'width: 100px;
            margin:auto;' ]); !!}</td>
  ...
  <div class="{{$col_class}}">
    <div class="form-group @if($readonly) hide @endif">
      ...
      <div class="input-group">
        ...
        "account_$row_index" : "account_advance_$row_index", 'style' => 'width:100%;', 'disabled' => $readonly]); !!}
      </div>
    </div>
  </div>
  @endif
