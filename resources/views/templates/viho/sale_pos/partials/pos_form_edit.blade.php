  ...
  <div class="col-md-4">
    <div class="form-group" style="width: 100% !important">
      <div class="input-group">
        ...
        phone', 'required', 'style' => 'width: 100%;']); !!}
...
<div class="row">
  ...
  <div class="col-md-4">
    <div class="form-group">
      ...
      $invoice_layouts, $transaction->location->invoice_layout_id, ['class' => 'form-control select2', 'placeholder' =>
  ...
  <div class="col-sm-4">
    <div class="form-group">
      ...
      $commission_agent, $transaction->commission_agent, ['class' => 'form-control select2', 'placeholder' =>
      __('lang_v1.commission_agent'), 'id' => 'commission_agent', 'required' => $is_commission_agent_required]); !!}
    </div>
  </div>
  @endif
  ...
  <div class="col-md-4 col-sm-6">
    <div class="form-group">
      <div class="input-group">
        ...
        'readonly', 'required', 'id' => 'transaction_date']); !!}
      </div>
    </div>
  </div>
  @endif
  ...
  <div class="col-md-4 col-sm-6">
    <div class="form-group">
      <div class="input-group">
        ...
        {!! Form::text('exchange_rate', @num_format($transaction->exchange_rate), ['class' => 'form-control input-sm
  ...
  <div class="col-md-4 col-sm-6">
    <div class="form-group">
      <div class="input-group">
        ...
        {!! Form::text('types_of_service_text', $transaction->types_of_service->name, ['class' => 'form-control',
        'readonly']); !!}
      ...
      <small>
        <p class="help-block @if(empty($transaction->selling_price_group_id)) hide @endif" id="price_group_text">
          ...
          <span>@if(!empty($transaction->selling_price_group_id)){{$transaction->price_group->name}}@endif</span></p>
      </small>
    </div>
  </div>
  ...
  <div class="col-sm-3">
    <div class="form-group">
      {!! Form::select('invoice_scheme_id', $invoice_schemes, $default_invoice_schemes->id, ['class' => 'form-control',
  ...
  <div class="col-md-3">
    <div class="form-group">
      <div class="checkbox">
        <label>
          {!! Form::checkbox('is_kitchen_order', 1, $transaction->is_kitchen_order, ['class' => 'input-icheck status',
          'id' => 'is_kitchen_order']); !!} {{ __('lang_v1.kitchen_order') }}
        </label>
      </div>
    </div>
  </div>
  ...
  <div class="col-md-4 col-sm-6">
    <label>
      {!! Form::checkbox('is_recurring', 1, $transaction->is_recurring, ['class' => 'input-icheck', 'id' =>
