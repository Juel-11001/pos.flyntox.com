<div class="row" id="featured_products_box" style="display: none;">
  ...
  @include('templates.viho.sale_pos.partials.featured_products')
  @endif
</div>
    ...
    <div class="tw-dw-drawer tw-dw-drawer-end">
      ...
      <div class="tw-dw-drawer-content">
        ...
        <label for="my-drawer-4"
          class="lg:tw-w-[98%] tw-w-full tw-flex tw-items-center tw-justify-center tw-gap-1 tw-text-base md:tw-text-lg tw-text-white tw-font-semibold tw-rounded-xl tw-h-12 tw-cursor-pointer hover:tw-opacity-90"
          style="background-color: #24695C;">
          <svg xmlns="http://www.w3.org/2000/svg" class="tw-w-5 icon icon-tabler icon-tabler-category-plus" width="44"
      ...
      <div class="tw-dw-drawer-side" style="z-index: 4000">
        ...
        <div class="tw-dw-menu tw-w-2/4 tw-min-h-full tw-bg-white tw-p-6">
          <div class="tw-flex tw-items-center tw-mb-16">
            <button type="button" class="tw-dw-btn tw-dw-btn-accent category-back tw-bg-transparent tw-border-2"
              style="display: none">
              <svg xmlns="http://www.w3.org/2000/svg" class="tw-w-5 icon icon-tabler icon-tabler-chevron-left"
            ...
            <h3
              class="tw-text-center tw-flex-grow mx-auto category_heading tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-inline-block tw-text-transparent tw-bg-clip-text tw-font-bold tw-text-base md:tw-text-2xl"
          ...
          <div class="row tw-mr-5">
            <div
              class="col-md-3 col-xs-12 tw-mb-7 tw-w-auto  tw-h-auto tw-cursor-pointer  main-category-div main-category no-print"
              ...
              <div
                ...
                <div class="tw-dw-card-actions tw-justify-center">
                  <button type="button"
                    ...
                    data-value="{{ $category['id'] }}" data-parent="0">{{ __('lang_v1.all') }}</button>
    ...
    <div class="tw-dw-drawer tw-dw-drawer-end">
      ...
      <div class="tw-dw-drawer-content">
        ...
        <label for="my-drawer-brand"
          class="lg:tw-w-[98%] tw-w-full tw-flex tw-items-center tw-justify-center tw-gap-1 tw-text-base md:tw-text-lg tw-text-white tw-font-semibold tw-rounded-xl tw-h-12 tw-cursor-pointer hover:tw-opacity-90"
          style="background-color: #24695C;">
          <svg xmlns="http://www.w3.org/2000/svg" class="tw-w-5 icon icon-tabler icon-tabler-brand-beats" width="44"
            height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round"
            stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
      ...
      <div class="tw-dw-drawer-side" style="z-index: 4000">
        ...
        <div class="tw-dw-menu tw-w-2/4 tw-min-h-full tw-bg-white tw-p-6">
          ...
          <div class="tw-flex tw-items-center tw-mb-16">
            <h3
              class="tw-text-center tw-mx-auto tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-text-transparent tw-bg-clip-text tw-font-bold tw-text-base md:tw-text-2xl tw-mb-16"
