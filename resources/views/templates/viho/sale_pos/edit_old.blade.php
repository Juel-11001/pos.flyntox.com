				...
				<div class="box-header with-border">
					<h3 class="box-title">
						...
						@elseif($transaction->status == 'final') 
							Invoice 
						@endif 
					<span class="text-success">#{{$transaction->invoice_no}}</span> <i class="fa fa-keyboard-o hover-q text-muted" aria-hidden="true" data-container="body" data-toggle="popover" data-placement="bottom" data-content="@include('templates.viho.sale_pos.partials.keyboard_shortcuts_details')" data-html="true" data-trigger="hover" data-original-title="" title=""></i></h3>
					<p><strong>@lang('sale.location'):</strong> {{$transaction->location->name}}</p>
					<div class="pull-right box-tools">
                <a class="btn btn-success btn-sm" href="{{ route('ai-template.pos.create') }}">
...
@endforeach
					...
					@include('templates.viho.sale_pos.partials.pos_details', ['edit' => true])
		...
		<div class="col-md-5 col-sm-12">
			@include('templates.viho.sale_pos.partials.right_div')
		</div>
	</div>
</section>
