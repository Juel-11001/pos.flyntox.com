      ...
      <div class="row">
        <div class="col-sm-12 col-md-6 col-xl-4 col-xxl-3">
          <div class="form-group">
            ...
            {!! Form::select('account_id', $accounts, null, ['class' => 'form-control select2', 'style' =>
            'width:100%'])
            !!}
          </div>
        </div>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="d-flex w-100 overflow-auto">
        <table class="table table-bordered table-striped" id="payment_account_report" style="min-width: 800px;">
          <thead>
            <tr>
