    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-sm-12 col-md-6 col-xl-4" id="location_filter">
            <div class="form-group">
          ...
          <div class="col-sm-12 col-md-6 col-xl-4">
            <div class="form-group">
              <br>
              <label>
                {!! Form::checkbox('woocommerce_enabled', 1, false, ['class' => 'input-icheck', 'id' =>
                'woocommerce_enabled']) !!}
    ...
    <div class="card">
      <div class="card-header pb-0">
        <ul class="nav nav-tabs nav-primary" id="product_tabs" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="product_list_tab_link" class='fs-6' data-bs-toggle="tab"
          ...
          <li class="nav-item">
            <a class="nav-link" id="product_stock_report_link" class='fs-6' data-bs-toggle="tab"
              href="#product_stock_report" role="tab" aria-controls="product_stock_report" aria-selected="false">
        ...
        <div class="tab-content" id="product_tabs_content">
          <div class="tab-pane fade show active" id="product_list_tab" role="tabpanel"
            ...
            <div class="mb-3 d-flex flex-wrap justify-content-end gap-2">
              ...
              @endif
              <a class="btn btn-primary btn-sm" href="{{ route('ai-template.products.create') }}">
