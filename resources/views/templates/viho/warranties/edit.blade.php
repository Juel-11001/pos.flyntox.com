  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
          ...
          <div class="row">
              <div class="col-md-6">
                  {!! Form::number('duration', $warranty->duration, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.duration' ), 'required' ]); !!}
              </div>
              <div class="col-md-6">
                  {!! Form::select('duration_type', ['days' => __('lang_v1.days'), 'months' => __('lang_v1.months'), 'years' => __('lang_v1.years')], $warranty->duration_type, ['class' => 'form-control','placeholder' => __('messages.please_select'), 'required']); !!}
              </div>
          </div>
      </div>
    </div>
