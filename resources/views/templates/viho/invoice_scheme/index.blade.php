    ...
    <div class="card">
      <div class="card-header">
        <ul class="nav nav-tabs">
          <li class="active"><a href="#tab_1" class='fs-6' data-toggle="tab"
              aria-expanded="true">@lang('invoice.invoice_schemes')</a></li>
          <li class=""><a href="#tab_2" class='fs-6' data-toggle="tab"
              aria-expanded="false">@lang('invoice.invoice_layouts')</a>
          </li>
        </ul>
      </div>
      <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <button class="btn btn-primary btn-sm pull-right btn-modal"
                  data-href="{{ route('ai-template.invoice-schemes.create') }}" data-container=".invoice_modal">
                  @lang('messages.add')
                </button>
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab_2">
            <div class="row">
              <div class="col-md-12">
                ...
                <a class="btn btn-primary btn-sm pull-right" href="{{ route('ai-template.invoice-layouts.create') }}">
                  @lang( 'messages.add' )
                </a>
              </div>
              <div class="col-md-12">
                ...
                <div class="col-md-3">
                  <div class="icon-link">
                    <a href="{{ route('ai-template.invoice-layouts.edit', [$layout->id]) }}">
