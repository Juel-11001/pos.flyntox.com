          ...
          @can('business_settings.access')
            <div>
              <button class="btn btn-primary btn-sm btn-modal"
                data-href="{{ route('ai-template.business-location.create') }}" data-container=".location_add_modal">
                @lang('messages.add')
              </button>
            </div>
          @endcan
...
@section('javascript')
  <script type="text/javascript">
    $(document).ready(function () {
      var business_location_table = $('#business_location_table_table').DataTable({
        processing: true,
        serverSide: true,
        ...
        {
          data: 'pos_invoice_layout',
          name: 'pos_invoice_layout'
        },
        {
          data: 'sale_invoice_layout',
          name: 'sale_invoice_layout'
        },
        {
          data: 'action',
          name: 'action'
