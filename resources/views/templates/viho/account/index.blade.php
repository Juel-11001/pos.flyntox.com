    ...
    <div class="col-sm-12">
      <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
          <li class="active">
            <a href="#other_accounts" class='fs-6' data-toggle="tab">
          ...
          {{--
                            ...
                            --}}
          <li>
            <a href="#account_types" class='fs-6' data-toggle="tab">
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="other_accounts">
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="col-md-8">
                  <button type="button"
                    class="tw-dw-btn bg-primary tw-font-bold text-white tw-border-none tw-rounded-full btn-modal pull-right"
                    data-container=".account_model" data-href="{{ route('ai-template.account.create') }}">
          ...
          <div class="tab-pane" id="account_types">
            <div class="row">
              <div class="col-md-12">
                <button type="button" class="tw-dw-btn btn-primary text-white tw-dw-btn-sm btn-modal pull-right"
                  data-href="{{ route('ai-template.account-types.create') }}" data-container="#account_type_modal">
                  ...
                  <tbody>
                    ...
                    <tr class="account_type_{{ $account_type->id }}">
                      ...
                      <td>
                        ...
                        {!! Form::open([
                        'url' => action([\App\Http\Controllers\AccountTypeController::class, 'destroy'],
                        $account_type->id),
                        'method' => 'delete',
                        ]) !!}
                        <button type="button"
