...
@php
    ...
    $go_back_url = $is_ai_template ? route('ai-template.pos.index') : route('pos.index');
    $transaction_sub_type = '';
    $view_suspended_sell_url = route('sells.index') . '?suspended=1';
    $pos_redirect_url = $is_ai_template ? route('ai-template.pos.create') : route('pos.create');
@endphp
