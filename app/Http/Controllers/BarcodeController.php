...
class BarcodeController extends Controller
{
    ...
    {
        return 'templates.viho.barcode.' . $view;
    }
            ...
            return Datatables::of($barcodes)
                ->addColumn(
                    ...
                    function ($row) {
                        ...
                        $edit_url = $is_viho
                            ? route('ai-template.barcodes.edit', [$row->id])
                            : route('barcodes.edit', [$row->id]);
                        $delete_url = $is_viho
                            ? route('ai-template.barcodes.destroy', [$row->id])
                            : route('barcodes.destroy', [$row->id]);
                        ...
                        if ($row->is_default) {
                            ...
                            $html .= '<button class="btn btn-xs btn-info set_default" data-href="' . $set_default_url . '">' . __('barcode.set_as_default') . '</button>';
                        }
    ...
    public function create()
    {
        ...
        return view($this->isAiTemplateRequest() ? $this->viewPath('create') : 'barcode.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view($this->isAiTemplateRequest() ? $this->viewPath('edit') : 'barcode.edit')
