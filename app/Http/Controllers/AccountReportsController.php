...
use App\{Account, AccountTransaction, BusinessLocation, TransactionPayment};
...
class AccountReportsController extends Controller
{
    ...
    {
        return 'templates.viho.account_reports.' . $view;
    }
    ...
    public function balanceSheet()
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('balance_sheet'))->with(compact('business_locations'));
        }
    ...
    public function trialBalance()
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('trial_balance'))->with(compact('business_locations'));
        }
    ...
    public function paymentAccountReport()
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('payment_account_report'))
    ...
    public function getLinkAccount($id)
    {
        ...
        if (request()->ajax()) {
            ...
            if ($this->isAiTemplateRequest()) {
                return view($this->viewPath('link_account_modal'))
