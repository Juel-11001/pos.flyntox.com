...
class SellController extends Controller
{
    ...
    public function index()
    {
        ...
        return view($this->isAiTemplateRequest() ? $this->viewPath('index') : 'sell.index')
    ...
    public function create()
    {
        ...
        return view($this->isAiTemplateRequest() ? $this->viewPath('create') : 'sell.create')
            ->with(compact(
                'business_details',
                'taxes',
                'walk_in_customer',
    ...
    public function edit($id)
    {
        ...
        return view($this->isAiTemplateRequest() ? $this->viewPath('edit') : 'sell.edit')
    ...
    public function getDrafts()
    {
        ...
        return view($this->isAiTemplateRequest() ? 'templates.viho.sale_pos.draft' : 'sale_pos.draft')
    ...
    public function getQuotations()
    {
        ...
        return view($this->isAiTemplateRequest() ? 'templates.viho.sale_pos.quotations' : 'sale_pos.quotations')
                ->with(compact('business_locations', 'customers', 'sales_representative'));
    }
    ...
    public function shipments()
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('shipments'))->with(compact('shipping_statuses'))
