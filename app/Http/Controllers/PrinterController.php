...
class PrinterController extends Controller
{
    ...
    {
        return 'templates.viho.printer.' . $view;
    }
            ...
            return Datatables::of($printer)
                ...
                ->addColumn(
                    ...
                    function ($row) {
                        ...
                        $edit_url = $is_viho
                            ? route('ai-template.printers.edit', [$row->id])
                            : route('printers.edit', [$row->id]);
                        $delete_url = $is_viho
                        ...
                        if (auth()->user()->can('printer.delete')) {
                            $html .= '<button data-href="' . $delete_url . '" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error delete_printer_button"><i class="glyphicon glyphicon-trash"></i> ' . __('messages.delete') . '</button>';
                        }
    ...
    public function create()
    {
        ...
        return view($this->isAiTemplateRequest() ? $this->viewPath('create') : 'printer.create')
    ...
    public function edit($id)
    {
        ...
        return view($this->isAiTemplateRequest() ? $this->viewPath('edit') : 'printer.edit')
