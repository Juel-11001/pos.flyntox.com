            ...
            return Datatables::of($tax_rates)
                ->addColumn(
                    ...
                    function ($row) {
                        ...
                        $edit_url = $is_viho
                            ? route('ai-template.group-taxes.edit', [$row->id])
                            : route('group-taxes.edit', [$row->id]);
                        $delete_url = $is_viho
                            ? route('ai-template.group-taxes.destroy', [$row->id])
                            : route('group-taxes.destroy', [$row->id]);

                        return '<button data-href="' . $edit_url . '" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline tw-dw-btn-primary btn-modal" data-container=".tax_group_modal"><i class="glyphicon glyphicon-edit"></i> ' . __('messages.edit') . '</button>
                            &nbsp;
                            <button data-href="' . $delete_url . '" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error delete_tax_group_button"><i class="glyphicon glyphicon-trash"></i> ' . __('messages.delete') . '</button>';
                    }
                )
