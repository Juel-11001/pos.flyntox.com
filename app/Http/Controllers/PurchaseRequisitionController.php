...
class PurchaseRequisitionController extends Controller
{
    ...
    {
        return 'templates.viho.purchase_requisition.' . $view;
    }
    ...
    public function index()
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('index') : 'purchase_requisition.index';
        return view($view)->with(compact('business_locations', 'purchaseRequisitionStatuses'));
    }
    ...
    public function create()
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('create') : 'purchase_requisition.create';
        return view($view)->with(compact('business_locations', 'categories', 'brands'));
    }
    ...
    public function show($id)
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('show') : 'purchase_requisition.show';
        return view($view)
    ...
    public function getRequisitionProducts()
    {
        if (request()->ajax()) {
            ...
            $view = $this->isAiTemplateRequest() ? $this->viewPath('product_list') : 'purchase_requisition.product_list';
    ...
    public function getPurchaseRequisitionLines($purchase_requisition_id)
    {
        ...
        $lines_view = $this->isAiTemplateRequest()
            ? $this->viewPath('partials.purchase_requisition_lines')
            : 'purchase_requisition.partials.purchase_requisition_lines';
        $html = view($lines_view)
                ->with(compact(
