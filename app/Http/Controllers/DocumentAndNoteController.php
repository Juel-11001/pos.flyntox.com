...
class DocumentAndNoteController extends Controller
{
    ...
    {
        return 'templates.viho.documents_and_notes.' . $view;
    }
    ...
    public function create()
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('create') : 'documents_and_notes.create';
        return view($view)
    ...
    public function show($id)
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('show') : 'documents_and_notes.show';
        return view($view)
    ...
    public function edit($id)
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('edit') : 'documents_and_notes.edit';
        return view($view)
    ...
    public function getDocAndNoteIndexPage(Request $request)
    {
        if (request()->ajax()) {
            ...
            $view = $this->isAiTemplateRequest() ? $this->viewPath('index') : 'documents_and_notes.index';
            return view($view)
