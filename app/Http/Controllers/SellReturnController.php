...
class SellReturnController extends Controller
{
    ...
    {
        return 'templates.viho.sell_return.' . $view;
    }
    ...
    public function index()
    {
                                ...
                                <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                    <li>
                                        <a href="#" class="btn-modal" data-container=".view_modal" 
                                            data-href="' . ($is_viho ? route('ai-template.sell-return.show', [$row->parent_sale_id]) : route('sell-return.show', [$row->parent_sale_id])) . '">
                                            <i class="fas fa-eye" aria-hidden="true"></i> ' . __('messages.view') . '
                                        </a>
                                    </li>
                                    <li>
                                        <a href="' . ($is_viho ? route('ai-template.sell-return.add', [$row->parent_sale_id]) : route('sell-return.add', [$row->parent_sale_id])) . '">
                                            <i class="fa fa-edit" aria-hidden="true"></i> ' . __('messages.edit') . '
                                        </a>
                                    </li>
                                    <li>
                                        <a href="' . ($is_viho ? route('ai-template.sell-return.destroy', [$row->id]) : route('sell-return.destroy', [$row->id])) . '" class="delete_sell_return">
                                            <i class="fa fa-trash" aria-hidden="true"></i> ' . __('messages.delete') . '
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="print-invoice" data-href="' . ($is_viho ? route('ai-template.sell-return.print', [$row->id]) : route('sell-return.print', [$row->id])) . '">
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('index'))->with(compact('business_locations', 'customers', 'sales_representative', 'is_service_staff_enabled', 'service_staffs'));
        }

        return view('sell_return.index')->with(compact('business_locations', 'customers', 'sales_representative', 'is_service_staff_enabled', 'service_staffs'));
    }
