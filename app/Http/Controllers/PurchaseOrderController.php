...
class PurchaseOrderController extends Controller
{
    ...
    {
        return 'templates.viho.purchase_order.' . $view;
    }
    ...
    public function index()
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('index') : 'purchase_order.index';
        return view($view)->with(compact('business_locations', 'suppliers', 'purchaseOrderStatuses', 'shipping_statuses'));
    }
    ...
    public function create()
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('create') : 'purchase_order.create';
        return view($view)
    ...
    public function show($id)
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('show') : 'purchase_order.show';
        return view($view)
    ...
    public function edit($id)
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('edit') : 'purchase_order.edit';
        return view($view)
            ->with(compact(
                'taxes',
                'purchase',
    ...
    public function downloadPdf($id)
    {
        ...
        //Generate pdf
        $receipt_view = $this->isAiTemplateRequest()
            ? $this->viewPath('receipts.download_pdf')
            : 'purchase_order.receipts.download_pdf';
        $body = view($receipt_view)
    ...
    public function getEditPurchaseOrderStatus(Request $request, $id)
    {
        ...
        if ($request->ajax()) {
            ...
            $view = $this->isAiTemplateRequest() ? $this->viewPath('edit_status_modal') : 'purchase_order.edit_status_modal';
            return view($view)
