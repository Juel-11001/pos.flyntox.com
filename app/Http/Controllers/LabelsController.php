...
class LabelsController extends Controller
{
     ...
     */
    protected function viewPath($view = 'show')
    {
        return 'templates.viho.labels.' . $view;
    }
    /**
     * Constructor
     *
    ...
    public function show(Request $request)
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('show') : 'labels.show';
        return view($view)->with(compact('products', 'barcode_settings', 'default', 'price_groups'));
    }
    ...
    public function addProductRow(Request $request)
    {
        if ($request->ajax()) {
            ...
            if (! empty($product_id)) {
                ...
                $partial = $this->isAiTemplateRequest() ? 'templates.viho.labels.partials.show_table_rows' : 'labels.partials.show_table_rows';
                return view($partial)->with(compact('products', 'index', 'price_groups'));
            }
        }
    }
