...
class ReportController extends Controller
{
    ...
    {
        return 'templates.viho.report.' . $view;
    }
    ...
    public function getProfitLoss(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            if ($this->isAiTemplateRequest()) {
                return view('templates.viho.report.partials.profit_loss_details', compact('data'))->render();
            }
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('profit_loss'), compact('business_locations'));
        }
    ...
    public function getPurchaseSell(Request $request)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('purchase_sell'))
    ...
    public function getStockReport(Request $request)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('stock_report'))
    ...
    public function getTaxReport(Request $request)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('tax_report'))
    ...
    public function getTrendingProducts(Request $request)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('trending_products'))
    ...
    public function getExpenseReport(Request $request)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('expense_report'))
    ...
    public function getStockAdjustmentReport(Request $request)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('stock_adjustment_report'))
                        ->with(compact('business_locations'));
        }
    ...
    public function getRegisterReport(Request $request)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('register_report'))
    ...
    public function getSalesRepresentativeReport(Request $request)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('sales_representative'))
    ...
    public function getStockExpiryReport(Request $request)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('stock_expiry_report'))
    ...
    public function getCustomerGroup(Request $request)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('customer_group'))
    ...
    public function getproductPurchaseReport(Request $request)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('product_purchase_report'))
    ...
    public function getproductSellReport(Request $request)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('product_sell_report'))
    ...
    public function getLotReport(Request $request)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('lot_report'))
    ...
    public function purchasePaymentReport(Request $request)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('purchase_payment_report'))
    ...
    public function sellPaymentReport(Request $request)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('sell_payment_report'))
    ...
    public function getTableReport(Request $request)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('table_report'))
                ->with(compact('business_locations'));
        }
    ...
    public function getServiceStaffReport(Request $request)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('service_staff_report'))
    ...
    public function itemsReport()
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('items_report'))->with(compact('suppliers', 'customers', 'business_locations'));
        }
    ...
    public function purchaseReport()
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('purchase_report'))
    ...
    public function saleReport()
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('sale_report'))
    ...
    public function activityLog()
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('activity_log'))->with(compact('users', 'transaction_types'));
        }
    ...
    public function gstSalesReport(Request $request)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('gst_sales_report'))->with(compact('customers', 'taxes'));
        }
    ...
    public function gstPurchaseReport(Request $request)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('gst_purchase_report'))->with(compact('suppliers', 'taxes'));
        }
