...
class TypesOfServiceController extends Controller
{
    ...
    {
        return 'templates.viho.types_of_service.' . $view;
    }
    ...
    public function index()
    {
            ...
            return Datatables::of($tax_rates)
                ->addColumn(
                    ...
                    function ($row) {
                        ...
                        $edit_url = $is_viho
                            ? route('ai-template.types-of-service.edit', [$row->id])
                            : route('types-of-service.edit', [$row->id]);
                        $delete_url = $is_viho
        ...
        return view($this->isAiTemplateRequest() ? $this->viewPath('index') : 'types_of_service.index');
    }
    ...
    public function create()
    {
        ...
        return view($this->isAiTemplateRequest() ? $this->viewPath('create') : 'types_of_service.create')
    ...
    public function edit($id)
    {
        ...
        return view($this->isAiTemplateRequest() ? $this->viewPath('edit') : 'types_of_service.edit')
