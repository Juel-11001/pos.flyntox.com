...
class WarrantyController extends Controller
{
    ...
    {
        return 'templates.viho.warranties.' . $view;
    }
    /**
    ...
    public function index()
    {
            ...
            return Datatables::of($warranties)
                ->addColumn(
                    ...
                    function ($row) {
                        ...
                        return
                            '<button data-href="' . $edit_href . '" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline tw-dw-btn-primary btn-modal" data-container=".view_modal"><i class="glyphicon glyphicon-edit"></i> ' . __("messages.edit") . '</button>';
                    }
                 )
                 ->removeColumn('id')
        ...
        return view($this->isAiTemplateRequest() ? $this->viewPath('index') : 'warranties.index');
    }
    ...
    {
        return view($this->isAiTemplateRequest() ? $this->viewPath('create') : 'warranties.create');
    }
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            $view = $this->isAiTemplateRequest() ? $this->viewPath('edit') : 'warranties.edit';
            return view($view)->with(compact('warranty'));
        }
    }
