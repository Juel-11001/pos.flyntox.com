...
class SalesOrderController extends Controller
{
    ...
    {
        return 'templates.viho.sales_order.' . $view;
    }
    ...
    public function index()
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('index') : 'sales_order.index';
        return view($view)
    ...
    public function getEditSalesOrderStatus(Request $request, $id)
    {
        ...
        if ($request->ajax()) {
            ...
            $view = $this->isAiTemplateRequest() ? $this->viewPath('edit_status_modal') : 'sales_order.edit_status_modal';
            return view($view)
