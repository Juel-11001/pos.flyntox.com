...
class ImportSalesController extends Controller
{
    ...
    {
        return 'templates.viho.import_sales.' . $view;
    }
    ...
    public function index()
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('index'))->with(compact('imported_sales_array', 'import_fields'));
        }
    ...
    public function preview(Request $request)
    {
        ...
        if ($request->hasFile('sales')) {
            ...
            if ($this->isAiTemplateRequest()) {
                return view($this->viewPath('preview'))->with(compact('parsed_array', 'import_fields', 'file_name', 'business_locations', 'match_array'));
            }
