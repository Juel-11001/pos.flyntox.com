...
class BusinessLocationController extends Controller
{
    ...
    {
        return 'templates.viho.business_location.' . $view;
    }
    ...
    public function index()
    {
            ...
            return Datatables::of($locations)
                ->addColumn('action', function ($row) {
                    ...
                    $edit_url = $is_ai_template
                        ? route('ai-template.business-location.edit', [$row->id])
                        : route('business-location.edit', [$row->id]);
                    $settings_url = $is_ai_template
                        ? url('ai-template/business-location/'.$row->id.'/settings')
                        : url('business-location/'.$row->id.'/settings');
                    $toggle_url = $is_ai_template
                    ...
                    $toggle_btn = '<button type="button" data-href="'.$toggle_url.'" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline activate-deactivate-location '.$toggle_class.' tw-w-max"><i class="fa fa-power-off"></i> '.$toggle_text.' </button>';

                    return $edit_btn.' '.$settings_btn.' '.$toggle_btn;
                })
                ->removeColumn('id')
        ...
        return view($this->isAiTemplateRequest() ? $this->viewPath('index') : 'business_location.index');
    }
    ...
    public function create()
    {
        ...
        return view($this->isAiTemplateRequest() ? $this->viewPath('create') : 'business_location.create')
                    ->with(compact(
                        'invoice_layouts',
                        'invoice_schemes',
                        'price_groups',
    ...
    public function edit($id)
    {
        ...
        return view($this->isAiTemplateRequest() ? $this->viewPath('edit') : 'business_location.edit')
                ->with(compact(
                    'location',
                    'invoice_layouts',
                    'invoice_schemes',
