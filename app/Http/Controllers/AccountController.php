...
class AccountController extends Controller
{
    ...
    {
        return 'templates.viho.account.' . $view;
    }
    ...
    public function getFundTransfer($id)
    {
        ...
        if (request()->ajax()) {
            ...
            if ($this->isAiTemplateRequest()) {
                return view($this->viewPath('transfer'))
    ...
    public function getDeposit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            if ($this->isAiTemplateRequest()) {
                return view($this->viewPath('deposit'))
    ...
    public function cashFlow()
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('cash_flow'))
    ...
    public function editAccountTransaction($id)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('edit_account_transaction'))
