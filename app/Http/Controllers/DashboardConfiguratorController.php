...
class DashboardConfiguratorController extends Controller
{
    ...
    {
        return 'templates.viho.dashboard_configurator.' . $view;
    }
    /**
    ...
    public function edit($id)
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('edit') : 'dashboard_configurator.edit';
        return view($view, compact('dashboard', 'available_widgets'));
    }
