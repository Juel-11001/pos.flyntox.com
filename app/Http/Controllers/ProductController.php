...
use App\{Brands, Business, BusinessLocation, Category, Media, Product, ProductVariation, PurchaseLine, SellingPriceGroup, TaxRate, TransactionSellLine, Unit, Variation, VariationGroupPrice, VariationLocationDetails, VariationTemplate, Warranty};
use App\Exports\ProductsExport;
use App\Utils\{ModuleUtil, ProductUtil};
...
class ProductController extends Controller
{
    ...
    {
        return 'templates.viho.product.' . $view;
    }
    ...
    public function show($id)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('show'))->with(compact('details'));
        }
    ...
    public function getProductVariationFormPart(Request $request)
    {
        ...
        if ($request->input('action') == 'add') {
            if ($request->input('type') == 'single') {
                $view = $this->isAiTemplateRequest() ? $this->viewPath('partials.single_product_form_part') : 'product.partials.single_product_form_part';
                return view($view)
                ...
                $view = $this->isAiTemplateRequest() ? $this->viewPath('partials.variable_product_form_part') : 'product.partials.variable_product_form_part';
                return view($view)
                        ->with(compact('variation_templates', 'profit_percent', 'action'));
            } elseif ($request->input('type') == 'combo') {
                $view = $this->isAiTemplateRequest() ? $this->viewPath('partials.combo_product_form_part') : 'product.partials.combo_product_form_part';
                return view($view)
            ...
            if ($request->input('type') == 'single') {
                ...
                $view = $this->isAiTemplateRequest() ? $this->viewPath('partials.edit_single_product_form_part') : 'product.partials.edit_single_product_form_part';
                return view($view)
    ...
    public function getVariationValueRow(Request $request)
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('partials.variation_value_row') : 'product.partials.variation_value_row';
        return view($view)
    ...
    public function getProductVariationRow(Request $request)
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('partials.product_variation_row') : 'product.partials.product_variation_row';
        return view($view)
    ...
    public function getComboProductEntryRow(Request $request)
    {
        if (request()->ajax()) {
            ...
            if (! empty($product_id)) {
                ...
                $view = $this->isAiTemplateRequest() ? $this->viewPath('partials.combo_product_entry_row') : 'product.partials.combo_product_entry_row';
                return view($view)
    ...
    public function quickAdd()
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('partials.quick_add_product') : 'product.partials.quick_add_product';
        return view($view)
    ...
    public function view($id)
    {
        ...
        try {
            ...
            $view = $this->isAiTemplateRequest() ? $this->viewPath('view-modal') : 'product.view-modal';
    ...
    public function addSellingPrices($id)
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('add-selling-prices') : 'product.add-selling-prices';
        return view($view)->with(compact('product', 'price_groups', 'variation_prices'));
    }
    ...
    public function viewGroupPrice($id)
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('view-product-group-prices') : 'product.view-product-group-prices';
        return view($view)->with(compact('product', 'allowed_group_prices', 'group_price_details'));
    }
    ...
    public function bulkEdit(Request $request)
    {
        ...
        if (! empty($selected_products_string)) {
            ...
            $view = $this->isAiTemplateRequest() ? $this->viewPath('bulk-edit') : 'product.bulk-edit';
            return view($view)->with(compact(
                'products',
                'categories',
                'brands',
    ...
    public function getProductToEdit($product_id)
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('partials.bulk_edit_product_row') : 'product.partials.bulk_edit_product_row';
        return view($view)->with(compact(
            'product',
            'categories',
            'brands',
    ...
    public function productStockHistory($id)
    {
        ...
        if ($this->isAiTemplateRequest()) {
            return view($this->viewPath('stock_history'))
