            ...
            return Datatables::of($unit)
                ->addColumn(
                    ...
                    function ($row) {
                        ...
                        $edit_href = $is_ai_template
                            ? route('ai-template.units.edit', [$row->id])
                            : route('units.edit', [$row->id]);
                        $delete_href = $is_ai_template
                            ? route('ai-template.units.destroy', [$row->id])
                            : route('units.destroy', [$row->id]);
