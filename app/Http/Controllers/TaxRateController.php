...
class TaxRateController extends Controller
{
    ...
    {
        return 'templates.viho.tax_rate.' . $view;
    }
    ...
    public function index()
    {
            ...
            return Datatables::of($tax_rates)
                ->addColumn(
                    ...
                    function ($row) {
                        ...
                        $edit_url = $is_viho
                            ? route('ai-template.tax-rates.edit', [$row->id])
                            : route('tax-rates.edit', [$row->id]);
                        $delete_url = $is_viho
                        ...
                        if (auth()->user()->can('tax_rate.delete')) {
                            $html .= '<button data-href="' . $delete_url . '" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error delete_tax_rate_button"><i class="glyphicon glyphicon-trash"></i> ' . __('messages.delete') . '</button>';
                        }
        ...
        return view($this->isAiTemplateRequest() ? $this->viewPath('index') : 'tax_rate.index');
    }
    ...
    public function create()
    {
        ...
        return view($this->isAiTemplateRequest() ? $this->viewPath('create') : 'tax_rate.create');
    }
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view($this->isAiTemplateRequest() ? $this->viewPath('edit') : 'tax_rate.edit')
