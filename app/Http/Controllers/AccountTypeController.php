...
class AccountTypeController extends Controller
{
    ...
    {
        return 'templates.viho.account_types.' . $view;
    }
    /**
    ...
    public function create()
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('create') : 'account_types.create';
        return view($view)
    ...
    public function edit($id)
    {
        ...
        $view = $this->isAiTemplateRequest() ? $this->viewPath('edit') : 'account_types.edit';
        return view($view)
